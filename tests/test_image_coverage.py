...
class TestImageCoverage:
    ...
    def mock_client(self):
        ...
        mock._request.return_value = b"binary_data"
    ...
    def test_upscale_with_bytes_data(self, image_resource):
        ...
        # Mock raw_response to return bytes
        # Set _request to directly return bytes
        ...
        assert "scale" in json_data  # Default scale is 2.0 if not provided
...
class TestAsyncImageCoverage:
    ...
    async def mock_async_client(self):
        ...
        mock = MagicMock()
        # Setup the _request method to handle binary responses
        mock._request = AsyncMock(return_value=b"binary_data")
        # Setup the post method for JSON responses
    ...
    async def test_async_upscale_with_bytes_data(self, async_image_resource):
        ...
        # Set _request to directly return bytes for async test
