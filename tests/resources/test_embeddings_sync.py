...
def test_embeddings_create_success(httpx_mock):
    """Tests successful creation of embeddings."""
    # Mock response data
    ...
    # Create client and call the create method
    client = VeniceClient(api_key="test-key")
    embeddings_list = client.embeddings.create(
        model="venice-embed-v1",
...
def test_embeddings_create_with_optional_params(httpx_mock):
    """Tests creating embeddings with optional parameters."""
    # Mock response data
    mock_response_data: MockEmbeddingList = {
        "object": "list",
        "data": [
...
def test_embeddings_create_api_error(httpx_mock):
    """Tests API error handling for embeddings creation."""
