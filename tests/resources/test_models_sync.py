...
def test_models_list_success(httpx_mock):
    """Tests successful retrieval of the models list."""
    ...
    # In a real scenario, you might want to validate against the TypedDict more strictly
    # For basic tests, checking key presence and types is often sufficient
...
def test_models_list_with_type_filter(httpx_mock):
    """Tests retrieval of models list with a type filter."""
    mock_response_data: MockModelList = {
        "object": "list",
        "data": [
            {
    ...
    client = VeniceClient(api_key="test-key")
    models_list = client.models.list(type="text")
...
def test_models_list_api_error(httpx_mock):
    """Tests API error handling for models list retrieval."""
    httpx_mock.add_response(
        method="GET",
        url="https://api.venice.ai/api/v1/models?type=all",
        status_code=401,
...
def test_models_list_traits_success(httpx_mock):
    """Tests successful retrieval of model traits."""
    mock_response_data = {
        "object": "list",
        "data": {
            "default": "model-1",
    ...
    client = VeniceClient(api_key="test-key")
    traits_list = client.models.list_traits()
...
def test_models_list_traits_with_type_filter(httpx_mock):
    """Tests retrieval of model traits with a type filter."""
    mock_response_data = {
        "object": "list",
        "data": {
            "default": "model-1",
    ...
    client = VeniceClient(api_key="test-key")
    traits_list = client.models.list_traits(type="text")
...
def test_models_list_traits_api_error(httpx_mock):
    """Tests API error handling for model traits retrieval."""
    httpx_mock.add_response(
        method="GET",
        url="https://api.venice.ai/api/v1/models/traits",
        status_code=401,
...
def test_models_list_compatibility_success(httpx_mock):
    """Tests successful retrieval of model compatibility mapping."""
    mock_response_data = {
        "object": "list",
        "data": {
            "gpt-4o": "model-1",
    ...
    client = VeniceClient(api_key="test-key")
    compatibility_list = client.models.list_compatibility()
...
def test_models_list_compatibility_with_type_filter(httpx_mock):
    """Tests retrieval of model compatibility mapping with a type filter."""
    mock_response_data = {
        "object": "list",
        "data": {
            "gpt-4o": "model-1",
    ...
    client = VeniceClient(api_key="test-key")
    compatibility_list = client.models.list_compatibility(type="text")
...
def test_models_list_compatibility_api_error(httpx_mock):
    """Tests API error handling for model compatibility mapping retrieval."""
    httpx_mock.add_response(
        method="GET",
        url="https://api.venice.ai/api/v1/models/compatibility_mapping",
        status_code=401,
    ...
    with pytest.raises(AuthenticationError) as excinfo:
        client.models.list_compatibility()
