...
- `venice-ai/references/model-resolution.md` — `resolve_video()`, `resolve_video_upscale()`, `resolve_cheapest_video()`.
- `venice-ai-production/references/error-taxonomy.md` — `VideoGenerationError.error_code` semantics.
