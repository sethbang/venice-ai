...
- `venice-ai/references/model-resolution.md` — `resolve_image()` and capability filters.
- `venice-ai-production/references/rate-limiting.md` — image-resource rate limits are tighter; throttle accordingly.
