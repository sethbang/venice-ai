...
- `venice-py/references/model-resolution.md` — `resolve_tts()` and `resolve_asr()`.
- `venice-py-production/references/rate-limiting.md` — audio-route rate limits differ from chat.
