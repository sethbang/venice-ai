...
- `venice-py-production/references/error-taxonomy.md` — when 429 hits, `RateLimitError.retry_after_seconds`.
- `venice-py-production/references/cost-tracking.md` — `CostTracker` reads `balance_info` automatically.
