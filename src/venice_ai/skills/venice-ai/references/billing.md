...
- **Confusing this with x402** — different surface, different shape. `client.x402.balance(...)` returns a `data`-envelope shape (see `venice-ai-x402/references/balance-and-topup.md`).

## See also

- `venice-ai/references/response-shapes.md` — quick cross-reference for all balance / usage shapes
- `venice-ai-production/references/cost-tracking.md` — the `CostTracker` / `BudgetManager` layer that consumes balance info automatically
- `venice-ai-x402/references/balance-and-topup.md` — wallet-funded billing surface, distinct from this
